#!/bin/bash -l
#SBATCH --job-name=generate_all_model_test_set_combos
#SBATCH --output=LOGS/generate_all_model_test_set_combos/%x_%j.log
#SBATCH --error=LOGS/generate_all_model_test_set_combos/%x_%j.err
...
echo "[INFO] Generating all model test set combos..."
srun python3 ${PROJECT_DIR}/generate_all_model_test_set_combos.py
