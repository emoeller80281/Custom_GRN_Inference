...
def plot_subscore_histogram(merged_peaks):
...
def plot_tf_tg_expression_to_score_scatterplot(merged_peaks):
...
def plot_population_score_histogram(merged_peaks):
...
def calculate_population_grn(rna_data, tf_to_peak_score, peak_to_tg_score):
    ...
    # print(tf_to_peak_score_and_expr.head())
