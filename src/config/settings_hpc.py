...
MOTIF_PRIOR_SCALE = 1.0         # Allows adding scaled motif scores on edges that are not filtered
SHORTCUT_L1 = 1e-2                 # Encourages sparsity between TF-TG edges in the TFtoTG shortcut
SHORTCUT_L2 = 0 #1e-3
SHORTCUT_TOPK = 30
SHORTCUT_DROPOUT = 0.2 #0.1
