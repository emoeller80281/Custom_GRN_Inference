...
features = [
    column for column in inferred_network.columns[2:-2]
]
...
inferred_network = inferred_network[["Source", "Target", "Prediction"]]
print(inferred_network.head())
inferred_network = inferred_network.rename(columns={"Prediction": "Score"})
