...
if __name__ == "__main__":
    ...
    if PROCESS_SAMPLE_DATA == True:
        ...
        for sample_name in SAMPLE_NAMES:
            ...
            output_dir = SAMPLE_PROCESSED_DATA_DIR / sample_name
            pseudobulk_rna_file = output_dir / "TG_pseudobulk.parquet"
            pseudobulk_atac_file = output_dir / "RE_pseudobulk.parquet"
            
            pseudobulk_rna_df = pd.read_parquet(pseudobulk_rna_file)
            pseudobulk_atac_df = pd.read_parquet(pseudobulk_atac_file)
            ...
            # ----- Split off the TFs and TGs from the gene list -----
