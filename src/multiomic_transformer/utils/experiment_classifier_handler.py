...
from multiomic_transformer.datasets.classifier_dataset import SimpleScaler
from multiomic_transformer.models.model_classifier import MultiomicTransformer
from multiomic_transformer.datasets.classifier_dataset import (
...
class ExperimentHandler:
    ...
    def prepare_dataloader(self, batch_size=None, world_size=1, rank=0,
        ...
        train_loader = DataLoader(
            ...
            collate_fn=partial(MultiChromosomeDataset.collate_fn, max_pairs=self.max_pairs_per_batch),
