...
MODEL_FILES=( \
    "$TRAINED_MODEL_DIR/xgb_all_features_raw_model.pkl" \ 
    "$TRAINED_MODEL_DIR/xgb_all_features_w_string_model.pkl" \ 
    "$TRAINED_MODEL_DIR/xgb_all_method_combos_raw_model.pkl" \
    "$TRAINED_MODEL_DIR/xgb_all_method_combos_summed_model.pkl" \
    "$TRAINED_MODEL_DIR/xgb_string_scores_only_model.pkl" \
)
