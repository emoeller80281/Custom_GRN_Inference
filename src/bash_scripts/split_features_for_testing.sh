...
K562_INFERRED_GRN_DIR="/gpfs/Labs/Uzun/SCRIPTS/PROJECTS/2024.SINGLE_CELL_GRN_INFERENCE.MOELLER/output/K562/K562_human_filtered/inferred_grns"
MACROPHAGE_INFERRED_GRN_DIR="$BASE_DIR/output/macrophage/macrophage_buffer1_filtered/inferred_grns"

/usr/bin/time -v python3 "${BASE_DIR}/src/testing_scripts/split_features_for_testing.py" \
    --inferred_grn_dir "${MACROPHAGE_INFERRED_GRN_DIR}"